...
import ru.pearx.carbide.Holder;
...
public class EventListTest
{
    ...
    public static class TestingContext
    {
        ...
        public List<String> lastCleared = new ArrayList<>();
        ...
        public EventList<String> ev = new EventList<>(new ArrayList<>(STARTING_LIST), new ListEventHandler<String>()
        {
            ...
            @Override
            public void onClear(Collection<String> col)
            {
                lastCleared.clear();
                lastCleared.addAll(col);
            }
    ...
    public void testMiscNotChanging()
    {
        ...
        assertEquals(OtherUtils.joinArray(", ", "[", "]", STARTING_ARRAY), context.ev.toString());
    }
    ...
    public void testClear()
    {
        ...
        context.ev.clear();
        assertEquals(STARTING_LIST, context.lastCleared);

        assertTrue(context.ev.isEmpty());
    }
